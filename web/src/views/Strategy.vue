<template>
  <div>
    <swiper :options="swiperOption" ref="mySwiper">
      ...
      <swiper-slide>
        <img class="w-100" src="../assets/images/banner2.png" alt />
      </swiper-slide>
      <swiper-slide>
        <img class="w-100" src="../assets/images/banner3.jpg" alt />
      </swiper-slide>
      <swiper-slide>
        <img class="w-100" src="../assets/images/banner4.jpg" alt />
      </swiper-slide>
      <!-- Optional controls -->
    ...
    <m-list-card icon="card-hero" title="精彩视频" :categories="videoCats">
      <template #items="{ category }">
        <div class="d-flex flex-wrap">
